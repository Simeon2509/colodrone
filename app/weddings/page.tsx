    ...
    <>
      ...
      <section className="sp-section" style={{ background: 'var(--bg)' }}>
        <div className="sp-inner">
          ...
          <p style={{ fontSize: '0.88rem', color: 'var(--muted)', lineHeight: 1.7, marginBottom: '0.75rem', maxWidth: '520px' }}>Flat-rate packages for every celebration. All edits delivered via private gallery link.</p>
