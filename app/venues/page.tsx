      ...
      <section className="sp-gallery">
        <div className="sp-gallery-inner">
          ...
          <div className="sp-gallery-grid">
            <div className="img-slot wide"><div className="img-slot-icon">📷</div><span>Property Overview</span></div>
            <div className="img-slot portrait"><div className="img-slot-icon">📷</div><span>Social Reel</span></div>
            <div className="img-slot"><div className="img-slot-icon">📷</div><span>Hotel Grounds</span></div>
            <div className="img-slot"><div className="img-slot-icon">📷</div><span>Event Venue</span></div>
            <div className="img-slot"><div className="img-slot-icon">📷</div><span>Golf Hole</span></div>
            <div className="img-slot portrait"><div className="img-slot-icon">📷</div><span>Golf Course Reel</span></div>
            <div className="img-slot"><div className="img-slot-icon">📷</div><span>Resort Amenities</span></div>
            <div className="img-slot wide"><div className="img-slot-icon">📷</div><span>Full Course Flyover</span></div>
          </div>
        </div>
      </section>
