    ...
    <>
      ...
      <section className="sp-section" style={{ background: 'var(--bg)' }}>
        <div className="sp-inner">
          ...
          <p style={{ fontSize: '0.88rem', color: 'var(--muted)', lineHeight: 1.7, marginBottom: '0.75rem', maxWidth: '520px' }}>Flat-rate packages for venues, hotels, resorts and golf courses across Colorado.</p>
